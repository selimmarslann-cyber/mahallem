  ...
  const calculateBusinessEarnings = async () => {
    ...
    try {
      ...
      if (ordersRes.ok) {
        ...
        const total = completed.reduce((sum: number, o: any) => sum + (parseFloat(o.totalAmount) || 0), 0)
        const monthly = thisMonth.reduce((sum: number, o: any) => sum + (parseFloat(o.totalAmount) || 0), 0)
        const pending = orders
          .filter((o: any) => o.status === 'COMPLETED' && o.paymentStatus !== 'CAPTURED')
        ...
        <div className="grid grid-cols-1 gap-4">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Toplam Kazancın</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Bu Ayın Kazancı</CardTitle>
            ...
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm text-gray-600 mb-2">
                  Başka esnafları veya müşterileri davet ederek komisyon payı kazan.
                </p>
              </div>
