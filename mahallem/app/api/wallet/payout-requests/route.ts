...
import { createPayoutRequest, getUserPayoutRequests } from '@/lib/services/walletService'
import { z } from 'zod'
    ...
    return NextResponse.json(
      {
        payoutRequest: {
          ...
          amount: typeof payoutRequest.amount === 'number' ? payoutRequest.amount : payoutRequest.amount.toNumber(),
