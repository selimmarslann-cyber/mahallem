...
import { Briefcase, MapPin, Menu, ArrowRight, CheckCircle2, Store } from 'lucide-react'
          ...
          <Card className="bg-white/95 backdrop-blur-md shadow-2xl border-2 border-white/20">
            <CardContent className="p-8 md:p-12">
              ...
              <p className="text-lg text-center text-gray-700 mb-8">
                Dükkanınızı Hizmetgo'e kaydedin ve mahallendeki müşterilerle buluşun. 
                Ücretsiz kayıt, kolay menü yönetimi ve anında görünürlük.
              </p>
              ...
              <p className="text-center text-sm text-gray-600 mt-6">
                Sorularınız mı var?{' '}
                <Link href="/partner" className="text-primary hover:underline font-semibold">
