...
import { Search, MapPin, Star, Phone, MessageCircle, FileText, Loader2, ChevronRight } from 'lucide-react'
...
export default function ServicesPage() {
  ...
  const handleSearch = async (e?: React.FormEvent) => {
    ...
    // URL'i güncelle
    router.replace(`/request?q=${encodeURIComponent(query)}`, { scroll: false })
  ...
  const handleRequestQuote = async (businessId: string) => {
    try {
      ...
      router.push(`/request/create?businessId=${businessId}&service=${encodeURIComponent(searchQuery)}`)
    } catch (err) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Hangi hizmete ihtiyacın var? Esnaflardan teklif al veya doğrudan iletişime geç.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div>
            <div className="mb-6">
              <p className="text-slate-600">
                <span className="font-semibold text-slate-900">{businesses.length}</span> esnaf bulundu
              </p>
            </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          {business.distance !== undefined && (
                            <div className="flex items-center gap-1 text-sm text-slate-600 mb-3">
                              ...
                              <span>{business.distance.toFixed(1)} km uzaklıkta</span>
                            </div>
                          )}
                        ...
                        <div className="flex flex-col gap-2 pt-4 border-t border-slate-100">
                          <Button
                            ...
                            className="w-full bg-[#FF6000] hover:bg-[#FF5500] text-white font-bold"
                          >
                          ...
                          {business.phone && (
                            <Button
                              ...
                              className="w-full border-[#FF6000] text-[#FF6000] hover:bg-[#FF6000]/10 font-bold"
                            >
