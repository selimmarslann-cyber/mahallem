...
const FEATURES = [
  {
    ...
    description: 'Yakınındaki esnafları canlı haritada gör, anında iletişime geç',
  },
  {
    icon: Briefcase,
    title: 'İş İlanı Ver',
  ...
  },
  {
    ...
    description: 'İş durumu, teklifler ve önemli güncellemeler için anlık bildirim',
  },
]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-600 mb-8 leading-relaxed">
              Temizlikten tamire, marketten çilingire kadar tüm esnaflar tek app'te.
              İndir, hemen başla.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <motion.a
                href="https://play.google.com/store/apps/details?id=com.mahallem.app"
                target="_blank"
              ...
              <motion.a
                ...
                onClick={(e) => {
                  e.preventDefault()
                  alert('App Store bağlantısı yakında eklenecek. Lütfen daha sonra tekrar deneyin.')
                }}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-block"
            ...
            <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl font-black text-orange-600 mb-1">4.8</div>
                ...
                <Card className="overflow-hidden hover:shadow-xl transition-all">
                  <div className="aspect-[9/16] bg-gradient-to-br from-orange-100 to-amber-100 flex items-center justify-center relative overflow-hidden">
                    <div className="text-center p-4 z-10">
                      ...
                      <p className="text-sm text-slate-600 font-medium">{screenshot.title}</p>
                    </div>
                    {/* Placeholder pattern */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Mahallendeki tüm işler için tek uygulama. Ücretsiz indir, hemen kullanmaya başla.
            </p>
