            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 mb-1">Çekilebilir Bakiye</p>
                ...
                <div className="pt-4 border-t">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-2xl font-bold">{referralStats.level1Earnings.toFixed(2)} ₺</p>
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-2xl font-bold">{referralStats.level2Earnings.toFixed(2)} ₺</p>
                      <p className="text-xs text-gray-500 mt-1">
