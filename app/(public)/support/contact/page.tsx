            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:destek@hizmetgo.app" className="text-sm text-gray-600 hover:text-[#FF6000]">
                    destek@hizmetgo.app
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+905551234567" className="text-sm text-gray-600 hover:text-[#FF6000]">
                    +90 (555) 123 45 67
                  </a>
                </div>
              </div>
          ...
          <Card className="border-2 border-[#FF6000]">
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">
                ...
                Bot sorununuzu çözemezse otomatik olarak destek ekibimize yönlendirilirsiniz.
              </p>
