...
export const PRODUCT_DATABASE: ProductData[] = [
  ...
  // Döner Çeşitleri
  {
    id: 'tavuk-doner',
    name: 'Tavuk Döner',
    nameVariations: ['tavuk döner', 'tavuk doner', 'tavuk döneri', 'tavuk doneri', 'chicken doner'],
    category: 'Döner',
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=500&h=500&fit=crop',
    ingredients: ['Tavuk eti', 'Marinasyon sosu', 'Soğan', 'Domates', 'Lahana', 'Mayonez', 'Ketçap'],
    description: 'Taze tavuk etinden yapılmış nefis döner',
  },
  {
    id: 'et-doner',
    name: 'Et Döner',
    nameVariations: ['et döner', 'et doner', 'kuzu döner', 'kuzu doner', 'dana döner'],
    category: 'Döner',
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=500&h=500&fit=crop',
    ingredients: ['Kuzu eti', 'Kuzu yağı', 'Soğan', 'Domates', 'Lahana', 'Ayran'],
  ...
  },
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=500&h=500&fit=crop',
    ingredients: ['Tavuk eti', 'Kuzu eti', 'Soğan', 'Domates', 'Lahana', 'Mayonez', 'Ketçap'],
  ...
  // Çorbalar
  {
    ...
    nameVariations: ['mercimek çorbası', 'mercimek corbasi', 'mercimek', 'lentil soup'],
    category: 'Çorba',
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=500&h=500&fit=crop',
    ingredients: ['Kırmızı mercimek', 'Soğan', 'Havuç', 'Patates', 'Tereyağı', 'Un', 'Tuz', 'Kırmızı biber'],
    description: 'Geleneksel Türk mercimek çorbası',
  },
  {
    id: 'ezogelin-corbasi',
    name: 'Ezo Gelin Çorbası',
    nameVariations: ['ezo gelin çorbası', 'ezogelin çorbası', 'ezo gelin corbasi', 'ezogelin corbasi'],
    category: 'Çorba',
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=500&h=500&fit=crop',
    ingredients: ['Bulgur', 'Domates salçası', 'Soğan', 'Sarımsak', 'Nane', 'Kırmızı biber', 'Tereyağı'],
    description: 'Güney Anadolu\'nun meşhur çorbası',
  },
  {
    id: 'tavuk-suyu-corbasi',
    name: 'Tavuk Suyu Çorbası',
    nameVariations: ['tavuk suyu çorbası', 'tavuk suyu corbasi', 'tavuk çorbası', 'tavuk corbasi', 'chicken soup'],
    category: 'Çorba',
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=500&h=500&fit=crop',
    ingredients: ['Tavuk suyu', 'Şehriye', 'Havuç', 'Soğan', 'Maydanoz', 'Limon', 'Tuz'],
  ...
  },
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=500&h=500&fit=crop',
    ingredients: ['Domates', 'Soğan', 'Sarımsak', 'Tereyağı', 'Un', 'Krema', 'Fesleğen'],
  ...
  // Pizza
  {
    ...
    ingredients: ['Pizza hamuru', 'Domates sosu', 'Mozzarella peyniri', 'Fesleğen', 'Zeytinyağı'],
    description: 'Klasik İtalyan pizza',
  },
  {
    id: 'karisik-pizza',
    name: 'Karışık Pizza',
    nameVariations: ['karışık pizza', 'karisik pizza', 'mix pizza', 'supreme pizza'],
    category: 'Pizza',
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500&h=500&fit=crop',
    ingredients: ['Pizza hamuru', 'Domates sosu', 'Mozzarella', 'Sucuk', 'Sosis', 'Biber', 'Mantar', 'Zeytin'],
  ...
  // Lahmacun
  {
    ...
    ingredients: ['İnce hamur', 'Kıyma', 'Soğan', 'Domates', 'Biber salçası', 'Maydanoz', 'Kırmızı biber'],
  ...
  // Pide
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=500&h=500&fit=crop',
    ingredients: ['Pide hamuru', 'Kıyma', 'Soğan', 'Biber', 'Domates', 'Yumurta'],
  ...
  // Kebap
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=500&h=500&fit=crop',
    ingredients: ['Kuzu kıyma', 'Kırmızı biber', 'Tuz', 'Sumak', 'Soğan', 'Domates', 'Biber'],
  ...
  },
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=500&h=500&fit=crop',
    ingredients: ['Kuzu kıyma', 'Kırmızı biber (acısız)', 'Tuz', 'Sumak', 'Soğan', 'Domates'],
  ...
  },
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=500&h=500&fit=crop',
    ingredients: ['Döner eti', 'Yoğurt', 'Domates sosu', 'Tereyağı', 'Pide', 'Biber'],
  ...
  // Köfte
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=500&h=500&fit=crop',
    ingredients: ['Kıyma', 'Soğan', 'Ekmek içi', 'Yumurta', 'Tuz', 'Karabiber', 'Kırmızı biber'],
  ...
  // Börek
  {
    ...
    ingredients: ['Yufka', 'Beyaz peynir', 'Maydanoz', 'Yumurta', 'Ayçiçek yağı'],
  ...
  },
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=500&h=500&fit=crop',
    ingredients: ['Yufka', 'Kıyma', 'Soğan', 'Biber salçası', 'Yumurta', 'Tereyağı'],
  ...
  // Pilav
  {
    ...
    category: 'Pilav',
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1589301760014-de94199738e7?w=500&h=500&fit=crop',
  ...
  // Salata
  {
    ...
    ingredients: ['Domates', 'Salatalık', 'Soğan', 'Biber', 'Maydanoz', 'Zeytinyağı', 'Limon', 'Tuz'],
  ...
  },
  {
    ...
    sector: 'RESTORAN',
    imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=500&h=500&fit=crop',
    ingredients: ['Marul', 'Domates', 'Salatalık', 'Havuç', 'Mısır', 'Zeytinyağı', 'Limon'],
  ...
  // Ekmek & Fırın
  {
    id: 'ekmek',
    name: 'Ekmek',
    nameVariations: ['ekmek', 'beyaz ekmek', 'tam buğday ekmek', 'ekmek 1 adet'],
    category: 'Fırın',
    sector: 'MARKET',
  ...
  },
  {
    id: 'kasar',
    name: 'Kaşar Peyniri',
    nameVariations: ['kaşar', 'kasarlı peynir', 'kaşar peyniri', 'kaşar 500 gr'],
    category: 'Süt Ürünleri',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=500&h=500&fit=crop',
    ingredients: ['Süt', 'Tuz', 'Maya'],
  ...
  },
  {
    ...
    category: 'Süt Ürünleri',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=500&h=500&fit=crop',
  ...
  },
  {
    id: 'aycicek-yagi',
    name: 'Ayçiçek Yağı',
    nameVariations: ['ayçiçek yağı', 'aycicek yagi', 'yağ', 'ayçiçek yağı 1 litre'],
    category: 'Temel Gıda',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1589301760014-de94199738e7?w=500&h=500&fit=crop',
  ...
  },
  {
    id: 'zeytinyagi',
    name: 'Zeytinyağı',
    nameVariations: ['zeytinyağı', 'zeytinyagi', 'zeytin yağı', 'zeytinyağı 500 ml'],
    category: 'Temel Gıda',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1589301760014-de94199738e7?w=500&h=500&fit=crop',
  ...
  // Sebze & Meyve
  {
    ...
    category: 'Sebze',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1546470427-e26264be0acc?w=500&h=500&fit=crop',
    ingredients: ['Domates'],
  ...
  },
  {
    ...
    category: 'Sebze',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1604977049385-4e03e6e5b1b0?w=500&h=500&fit=crop',
  ...
  },
  {
    ...
    category: 'Meyve',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1611080626919-7cf5e9baab5c?w=500&h=500&fit=crop',
  ...
  // Et & Tavuk
  {
    ...
    category: 'Et',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1603048297172-c92544798d5a?w=500&h=500&fit=crop',
  ...
  // İçecekler
  {
    ...
    category: 'İçecek',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1548839140-5a059f41d1d3?w=500&h=500&fit=crop',
  ...
  // Konserve & Hazır
  {
    ...
    nameVariations: ['domates salçası', 'domates salcasi', 'salça', 'domates salçası 400 gr'],
    category: 'Konserve',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1546470427-e26264be0acc?w=500&h=500&fit=crop',
  ...
  },
  {
    id: 'biber-salcasi',
    name: 'Biber Salçası',
    nameVariations: ['biber salçası', 'biber salcasi', 'acı biber salçası', 'biber salçası 400 gr'],
    category: 'Konserve',
    sector: 'MARKET',
    imageUrl: 'https://images.unsplash.com/photo-1604977049385-4e03e6e5b1b0?w=500&h=500&fit=crop',
  ...
  },
  {
    id: 'sakal-tiras',
    name: 'Sakal Tıraşı',
    nameVariations: ['sakal tıraşı', 'sakal trası', 'sakal kesimi', 'beard trim'],
    category: 'Erkek Hizmetleri',
    sector: 'KUAFOR',
    imageUrl: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=500&h=500&fit=crop',
    ingredients: ['Tıraş makinesi', 'Tıraş köpüğü', 'Aftershave', 'Nemlendirici'],
  ...
  },
  {
    ...
    sector: 'TESISAT',
    imageUrl: 'https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=500&h=500&fit=crop',
    ingredients: ['Tıkanıklık açma makinesi', 'Kimyasal temizleyici', 'Eldiven'],
  ...
  },
  {
    ...
    nameVariations: ['lamba değiştirme', 'lamba degistirme', 'ampul değiştirme'],
    category: 'Elektrik Hizmetleri',
    sector: 'ELEKTRIK',
    imageUrl: 'https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=500&h=500&fit=crop',
  ...
  },
  {
    ...
    nameVariations: ['dış cephe boyama', 'dis cephe boyama', 'exterior painting'],
    category: 'Boya Hizmetleri',
    sector: 'BOYA',
    imageUrl: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=500&h=500&fit=crop',
 ...
 */
export function findProductByName(name: string, sector?: string): ProductData | null {
  ...
  const matches = PRODUCT_DATABASE.filter(product => {
    ...
    return product.nameVariations.some(variation => 
  ...
  if (matches.length > 0) {
    return matches.sort((a, b) => {
      const aMatch = a.nameVariations.find(v => lowerName.includes(v.toLowerCase()))
      const bMatch = b.nameVariations.find(v => lowerName.includes(v.toLowerCase()))
 ...
 */
export function getProductSuggestions(sector: string, query: string = ''): ProductData[] {
  ...
  return sectorProducts
    .filter(product => 
      product.nameVariations.some(v => v.toLowerCase().includes(lowerQuery)) ||
