...
import type { UserProfile, Job, SkillKeyword, Earnings } from "../types/mahallem"
...
interface HizmetgoState {
  ...
  addEarnings: (userId: string, amount: number, type: "job" | "referral") => void
      ...
      const updated = state.earnings.map((e) =>
        e.userId === userId
          ? {
              ...
              referralEarnings: e.referralEarnings + (type === "referral" ? amount : 0),
