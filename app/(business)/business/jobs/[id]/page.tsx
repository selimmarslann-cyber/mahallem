        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Sipariş #{order.id.slice(0, 8)}</p>
            </div>
            <Badge variant={statusInfo.variant} className="flex items-center gap-2 text-base px-4 py-2">
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500">
                            Adet: {item.quantity} × {parseFloat(item.product?.price || 0).toFixed(2)} ₺
                          </p>
                        </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 border-t space-y-3">
                  ...
                  {order.scheduledAt && (
                    <div>
                      <p className="text-sm text-gray-500 mb-1">Planlanan Tarih & Saat</p>
