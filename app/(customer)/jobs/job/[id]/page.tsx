              ...
              {pendingOffers.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400">
                    Uygun esnaflara bildirim gönderildi. Teklifler geldiğinde burada görünecek.
                  </p>
                </div>
              ) : (
            ...
            <CardContent>
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <Building2 className="w-5 h-5 text-primary" />
                    <h3 className="font-semibold text-lg">{acceptedOffer.business.name}</h3>
                  </div>
                  <div className="flex items-center gap-4 mb-3">
                    <div className="flex items-center gap-1 text-sm text-gray-600">
                      <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                  ...
                  {acceptedOffer.message && (
                    <div className="mb-3 p-3 bg-white rounded-lg">
                      <p className="text-sm text-gray-700">{acceptedOffer.message}</p>
                    </div>
                  )}
                </div>
                <div className="text-right">
                  <p className="text-sm text-gray-500 mb-1">Kabul Edilen Fiyat</p>
            ...
            <DialogDescription>
              {selectedOffer && (
                <>
                  ...
                  <strong>{selectedOffer.amount.toFixed(2)} ₺</strong> teklifini kabul etmek
