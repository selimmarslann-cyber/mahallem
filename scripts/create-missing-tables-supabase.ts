...
async function createMissingTables() {
  ...
  try {
    ...
    if (!response.ok) {
      console.log('⚠️  Cannot query tables directly, will check migration files...\n')
      ...
      console.log('💡 Since we cannot execute SQL directly via Supabase JS client,')
      console.log('   please apply the following migrations manually in Supabase SQL Editor:\n')
