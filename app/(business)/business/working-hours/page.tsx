...
export default function WorkingHoursPage() {
  ...
  const updateDay = (day: DayOfWeek, field: 'open' | 'close' | 'closed', value: string | boolean) => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            İşletmenizin çalışma saatlerini belirleyin. Mesai saatleri dışında otomatik offline'a geçersiniz.
          </p>
        </div>
        ...
        <Card className="mt-6 bg-blue-50 border-blue-200">
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-blue-900 mb-1">Otomatik Kapanma</p>
                <p className="text-sm text-blue-700">
                  Mesai saati bittiğinde işletmeniz otomatik olarak offline'a geçer. 
                  Yeni siparişler gelmez ve mevcut siparişleriniz korunur.
                </p>
              </div>
            </div>
          </CardContent>
