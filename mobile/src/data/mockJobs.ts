...
export const mockJobs: Job[] = [
  {
    ...
    description: 'Yeni yapılan 3+1 daire için komple elektrik tesisatı yapılacak. Tüm kablolar, prizler, anahtar ve aydınlatma dahil.',
    timeAgo: '2 saat önce',
  },
  {
    id: 2,
    ...
    description: '3+1 ev için derinlemesine temizlik. Banyo, mutfak, camlar dahil.',
    timeAgo: '5 saat önce',
  },
  {
    id: 3,
    ...
    budget: '300',
    location: 'Kadıköy',
    description: 'Köpeğimi bu akşam 1 saat gezdirilmesi gerekiyor. Deneyimli biri tercih edilir.',
    timeAgo: '1 saat önce',
  },
  {
    id: 4,
    ...
    budget: '3.000',
    location: 'Beşiktaş',
    description: '3 gün boyunca köpeğime bakılması gerekiyor. Evde kalabilir veya günlük ziyaret edebilir.',
    timeAgo: '3 saat önce',
  },
  {
    id: 5,
    ...
    budget: '2.500',
    location: 'Çorlu',
    description: 'Cumartesi ve Pazar günü depo sayımı yapılacak. 2 kişi aranıyor.',
    timeAgo: '6 saat önce',
  },
  {
    id: 6,
    ...
    budget: '1.500',
    location: 'Şişli',
    description: 'Yarın sabah 09:00\'da başlayacak ev temizliği için yardımcı aranıyor.',
    timeAgo: '8 saat önce',
  },
  {
    id: 7,
