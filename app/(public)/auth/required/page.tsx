...
export default function AuthRequiredPage() {
  ...
  const getPageInfo = () => {
    const pageMap: Record<string, { title: string; description: string; icon: any }> = {
      'İşlerim': {
        title: 'İşlerim',
        description: 'Verdiğin işleri takip et, esnaflardan gelen teklifleri gör',
        icon: Briefcase,
      },
      'Kazancım': {
        title: 'Kazancım',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-500">Kontrol ediliyor...</p>
        </div>
      </div>
    )
  }
          ...
          <div className="bg-gradient-to-br from-primary via-primary/90 to-primary/80 p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-center text-white/90 text-lg">
                {pageInfo.title} sayfasını görüntülemek için üye olmanız gerekmektedir
              </p>
            </div>
          </div>
