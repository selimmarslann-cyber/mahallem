...
export function useToast() {
  ...
  const toast = useCallback(
    (description: string, variant: ToastVariant = 'default', title?: string) => {
  ...
  const success = useCallback(
    (description: string, title?: string) => {
      return addToast({ description, variant: 'success', title: title || 'Başarılı' })
    },
    [addToast]
  )
  ...
  const error = useCallback(
    (description: string, title?: string) => {
      return addToast({ description, variant: 'error', title: title || 'Hata' })
    },
    [addToast]
  )
  ...
  const warning = useCallback(
    (description: string, title?: string) => {
      return addToast({ description, variant: 'warning', title: title || 'Uyarı' })
    },
    [addToast]
  )
  ...
  const info = useCallback(
    (description: string, title?: string) => {
      return addToast({ description, variant: 'info', title: title || 'Bilgi' })
    },
    [addToast]
  )
...
let globalToastHandler: ((description: string, variant?: ToastVariant, title?: string) => void) | null = null

export function setGlobalToastHandler(handler: typeof globalToastHandler) {
  globalToastHandler = handler
}

export function showToast(description: string, variant: ToastVariant = 'default', title?: string) {
