...
export default function UserRegisterScreen() {
  ...
  const handleFinalSubmit = () => {
    ...
    Alert.alert('Başarılı', 'Kayıt başarıyla tamamlandı', [
      { text: 'Tamam', onPress: () => navigation.navigate('MainTabs' as never) },
    ])
  }
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {step === 1 ? 'Kayıt Ol' : step === 2 ? 'SMS Doğrulama' : 'Profil Bilgileri'}
        </Text>
      ...
      >
        ...
        {step === 2 && (
          <View style={styles.stepContainer}>
            ...
            <TouchableOpacity style={styles.primaryButton} onPress={handleSMSVerify}>
        ...
        {step === 3 && (
          <View style={styles.stepContainer}>
            ...
            <View style={styles.inputContainer}>
              ...
              >
                <Text style={[styles.pickerText, !neighborhood && styles.placeholderText]}>
