...
2. `.env` dosyasını oluşturun ve tüm gerekli environment variable'ları ekleyin:
   - Detaylar için `ENV_REQUIREMENTS.md` dosyasına bakın
   - Tüm yapılandırmalar `.env` dosyasından alınır, default değerler yoktur
