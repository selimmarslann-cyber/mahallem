...
1.1. Bu sözleşme, Mahallem platformunu kullanan tüm kullanıcılar için geçerlidir.

1.2. Platformu kullanarak, bu sözleşmenin tüm hükümlerini kabul etmiş sayılırsınız.

1.3. Mahallem, platform üzerinden sunulan hizmetlerin kalitesinden sorumlu değildir.
...
3.2. Mahallem, hizmet sağlayıcıların kalitesini garanti etmez.
...
6.1. Mahallem, platform üzerinden sunulan hizmetlerin sonuçlarından sorumlu değildir.

6.2. Kullanıcılar, kendi riskleri altında platformu kullanır.

7. FİKRİ MÜLKİYET

7.1. Platform içeriği Mahallem'e aittir.

7.2. İçeriklerin izinsiz kullanımı yasaktır.

8. DEĞİŞİKLİKLER

8.1. Mahallem, bu sözleşmeyi istediği zaman değiştirme hakkına sahiptir.
...
10.1. Sorularınız için destek@mahallem.com adresine ulaşabilirsiniz.

Bu sözleşme, Mahallem platformunu kullandığınız andan itibaren geçerlidir.
`
