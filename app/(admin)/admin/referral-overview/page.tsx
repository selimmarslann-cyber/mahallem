...
export default function AdminReferralOverviewPage() {
  ...
  const loadData = async () => {
    try {
      const res = await fetch('/api/admin/referral-stats', { credentials: 'include' })
      if (res.ok) {
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">En çok kazananlar ve bölge istatistikleri</p>
      </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Rank: {earner.referral_rank} | GMV: {formatCurrency(earner.network_gmv)}
                      </p>
                    </div>
                  </div>
