...
import { Coins, TrendingUp, Copy, Share2, MessageCircle, Sparkles } from 'lucide-react'
      ...
      <div className="bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 text-white">
        <div className="max-w-md mx-auto px-4 py-8">
          ...
          >
            ...
            <p className="text-white/90 text-sm">Kazancını takip et, arkadaşlarını davet et</p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          >
            <Card className="border-2 border-amber-200 shadow-lg bg-gradient-to-br from-white to-amber-50">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-semibold text-slate-700">Kullanılabilir Bakiyen</CardTitle>
                <motion.div
          ...
          >
            <Card className="border-2 border-emerald-200 shadow-lg bg-gradient-to-br from-white to-emerald-50">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-semibold text-slate-700">Referral Kazancın</CardTitle>
              ...
              <CardContent>
                ...
                <Link href="/referral">
                  <Button variant="ghost" size="sm" className="mt-2 text-xs text-emerald-600 hover:text-emerald-700">
                    Detayları gör →
                  </Button>
                </Link>
              </CardContent>
          ...
          >
            <Card className="border-2 border-blue-200 shadow-lg bg-gradient-to-br from-white to-blue-50">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-semibold text-slate-700">Bu Ay Referral Kazancın</CardTitle>
          ...
          >
            <Card className="border-2 border-amber-200 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-t-lg">
                <CardTitle className="text-lg font-bold text-slate-900">Arkadaşın sipariş verdikçe kazanç elde et</CardTitle>
              </CardHeader>
