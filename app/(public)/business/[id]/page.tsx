    ...
    return (
      <div className="min-h-screen bg-[#F5F5F7] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-2">İşletme bulunamadı</h2>
          <p className="text-slate-600 mb-4">Aradığınız işletme mevcut değil.</p>
    ...
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <Badge
                      variant={business.onlineStatus === 'ONLINE' ? 'default' : 'secondary'}
                      className={
                  ...
                  <div className="flex items-center gap-2 text-slate-600">
                    ...
                    <span className="text-sm">{business.addressText || 'Adres belirtilmemiş'}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 md:min-w-[200px]">
                  ...
                  <Button
                    variant="outline"
                    className="w-full"
                    onClick={() => router.push(`/request?businessId=${business.id}`)}
                  >
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-slate-900">
              {business.businessType === 'restaurant' ? 'Menü' : 'Ürünler ve Hizmetler'}
            </h2>
            <Badge variant="outline" className="text-sm">
          ...
          {products.length === 0 ? (
            <Card className="border-2 border-slate-200">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-slate-600 font-medium">Henüz ürün/hizmet eklenmemiş</p>
              </CardContent>
            </Card>
          ) : (
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                            ...
                            <Button
                              ...
                              disabled={business.onlineStatus !== 'ONLINE' || !product.active}
        ...
        {business.reviewCount > 0 && (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-slate-900">Değerlendirmeler</h2>
                  ...
                  <Card key={review.id} className="border-2 border-slate-200">
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <p className="font-semibold text-slate-900">{review.reviewer?.name || 'Anonim'}</p>
