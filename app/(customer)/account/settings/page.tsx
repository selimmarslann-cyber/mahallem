      ...
      >
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onChange={(e) => setSecurity(prev => ({ ...prev, phone: e.target.value }))}
            ...
            <Button onClick={handleSaveSecurity} disabled={saving} className="mt-4">
      ...
      >
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={handleSaveLocation} disabled={saving} className="mt-4">
              <Save className="w-4 h-4 mr-2" />
              {saving ? 'Kaydediliyor...' : 'Kaydet'}
            </Button>
          </CardContent>
