...
export default function EarningsChart({ data, title = 'Kazanç Trendi' }: EarningsChartProps) {
  ...
  const points = data.map((item, index) => {
    ...
    const y = chartHeight - padding - (item.amount / maxAmount) * (chartHeight - 2 * padding)
