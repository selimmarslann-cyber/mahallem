...
import { Search, MessageSquare, User, Calendar, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Tüm destek taleplerini görüntüleyin ve yönetin</p>
      </div>
